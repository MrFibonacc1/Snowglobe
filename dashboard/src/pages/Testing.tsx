...
// per VLM call (VLM_TIMEOUT) and a video runs several frames sequentially, so a
// flat 20s aborted valid multi-frame runs mid-flight (a 5-frame clip on the 90B
// vision model lands right around 20s).
